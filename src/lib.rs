...
pub struct ServerVariable {
    ...
    /// not supplied.
    ///
    /// Note this behavior is different than the Schema Object's treatement of default values,
...
pub struct ContentDescriptor {
    ...
    ///
    /// If the content described is a method parameter assignable [`ByName`](ParamStructure::ByName),
...
pub struct Error {
    ...
    ///
    /// This may be omitted. The specifics of this value are defined by the server.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    #[cfg(feature = "serde_json")]
...
mod serde_fns {
    ...
    /// Returns the default value of the `servers` field of [`OpenRpc`].
    ...
    /// Returns the default vlaue
    #[cfg(feature = "relaxed")]
    pub fn runtime_expr() -> RuntimeExpression {
        RuntimeExpression(String::new())
    }

    /// Returns the default openRPC version.
    #[cfg(feature = "relaxed")]
    pub fn openrpc_version() -> String {
        "1.0.0-rc1".into()
    }

    /// Returns a default instance of [`Info`].
    #[cfg(feature = "relaxed")]
    pub fn info() -> Info {
        Info {
